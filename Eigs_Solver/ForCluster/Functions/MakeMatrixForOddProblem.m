function M = MakeMatrixForOddProblem(N,G, PsiE, ThetaE, Ra, Pr)
    ...
    for i=1:length(n)
        ...
        for j=1:length(OnesWeWant)
            ...
            % Adding to psi1
            psi1(i,columninst) = psi1(i,columninst) + (Square(nodd,modd,G) - Square(neven,meven,G))*AFact*PsiFact*iktfact*(1i/2);
            % Adding psi2
