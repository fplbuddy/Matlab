...
%% making inserts
    ...
    h = figure('Renderer', 'painters', 'Position', [5 5 600 200]);
    ...
    yticks([RaC-10 RaC RaC+10])
    yticklabels({'$Ra_c-10$' '$Ra_c$' '$Ra_c+10$'})
    ...
    set(gcf,'Color',[0 0 0]);
    print(gcf,['/Users/philipwinchester/Desktop/SmallPr2.png'],'-dpng','-r300');
