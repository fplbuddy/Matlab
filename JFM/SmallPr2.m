...
text(4e-5, 1, '$\delta Ra = 6.35 \times 10^4 Pr^2$', 'FontSize',LabelFS, 'Color','red')
text(6e-6, 1e-1, '$US$', 'FontSize',LabelFS, 'Color','white')
text(6e-6, 1e-7, '$S$', 'FontSize',LabelFS, 'Color','k')
