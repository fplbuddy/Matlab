...
r = 1.6e4;
rS = rtorS(r);
plot(WNLData.G_2.eps_0_001.(rS).t, exp(WNLData.G_2.eps_0_001.(rS).theta), 'Color', 'Blue'), hold on
plot(WNLData.G_2.eps_0_001.(rS).t, exp(WNLData.G_2.eps_0_001.(rS).phi), 'Color', 'red')
xlim([0.008 0.01])
ax = gca;
ax.XAxis.FontSize = numFS;
ax.YAxis.FontSize = numFS;
text(0.00801,3700,"(b), $r =  1.6 \times 10^4$","FontSize", LabelFS)
...
text(0.00801,12400,"(c), $r = 3 \times 10^4$","FontSize", LabelFS)
