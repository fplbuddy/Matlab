...
semilogx(1:length(fenresult),fenresult, 'b-o', 'Displayname','$\langle u \cdot F \rangle$')
semilogx(1:length(denresult),-denresult*nu, 'r-o', 'Displayname','$\nu \langle u\cdot\nabla^{2n}u \rangle$')
semilogx(1:length(henresult),-henresult*hmu, 'm-o', 'Displayname','$\mu \langle u\cdot \nabla^{-1}u \rangle$')
